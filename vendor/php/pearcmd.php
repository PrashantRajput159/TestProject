...
if ('/var/www/html/jenkinphing/Ci-Php-Phing-Example/vendor/php ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('/var/www/html/jenkinphing/Ci-Php-Phing-Example/vendor/php '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
