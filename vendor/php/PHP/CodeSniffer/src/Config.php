        ...
        if ($temp === false) {
            ...
            if ($path !== '') {
                ...
                if (is_file($configFile) === false
                    && strpos('/var/www/html/jenkinphing/Ci-Php-Phing-Example/vendor/data', '@data_dir') === false
                ) {
                    // If data_dir was replaced, this is a PEAR install and we can
                    // use the PEAR data dir to store the conf file.
                    $configFile = '/var/www/html/jenkinphing/Ci-Php-Phing-Example/vendor/data/PHP_CodeSniffer/CodeSniffer.conf';
                }
            }
